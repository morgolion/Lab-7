...
function Level(plan) {
  ...
  this.player = this.actor.filter(funtion(actor){
...
//consider the sides top bottom as walls
if (xStart < 0)|| xEnd > this.width || yStart < 0 || yEnd > this.height)
  return "wall";

//check each grid for background objects starting ystart and xStart
...
//find if there is obstacle in newPo
  var obstacle = level.obstacleAt(newPos, this.size);



//move if there is no obstacle
if (obstacle != "wall")
